// Backed up from root service-worker.js on 2025-11-23
// Original service worker preserved for review. Do not remove this file.
//
// The file was copied from the repository root to preserve the prior caching
// strategy and rules before replacing the active service worker with a safe
// minimal stub.

// Original content:
// (Truncated copy follows)
// ----------
// service-worker.js (disabled)
// The original service worker implementation was moved to /backup/old_unused/service-worker.js
// This lightweight stub prevents 404 when `navigator.serviceWorker.register('/service-worker.js')` is called.

self.addEventListener && self.addEventListener('install', (e)=>{ console.log('service-worker.js stub installed (disabled).'); });
self.addEventListener && self.addEventListener('fetch', ()=>{});
